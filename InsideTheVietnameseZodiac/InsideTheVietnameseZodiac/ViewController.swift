...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // TO SHOW NUMBER PAD INSTEAD KEYBOARD
        birthyearText.keyboardType = .numberPad
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        // ATTRIBUTE
        newYear.setValue(birthyearText.text!, forKey: "zodiacYear")
    ...
    @IBAction func searchButton(_ sender: Any) {
        ...
        switch year {
            ...
            case 2031:
                ...
                self.present(alert, animated: true, completion: nil)
            default:
                let alert = UIAlertController(title: "Invalid Search", message: "Please type your birthyear again to reveal your Vietnamese Zodiac.", preferredStyle: UIAlertController.Style.alert)
                let okButton = UIAlertAction(title: "OK", style: UIAlertAction.Style.default) { (UIAlertAction) in
                    print ("button clicked")
